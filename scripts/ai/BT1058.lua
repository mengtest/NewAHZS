...
BT1058 = Mogo.AI.BehaviorTreeRoot:new()

function BT1058:new()
		 
			local tmp = {}
			setmetatable(tmp, {__index = BT1058})
			tmp.__index = tmp
				...
				do
					...
					do
						...
						do
							...
							do
								...
								do
									...
									node14:AddChild(Mogo.AI.CmpRate:new(Mogo.AI.CmpType.lt,50));
						...
						do
							...
							do
								...
								do
									...
									node25:AddChild(Mogo.AI.CmpRate:new(Mogo.AI.CmpType.lt,80));
						...
						do
							...
							node33:AddChild(Mogo.AI.EnterRest:new(200));
						end
					end
				end
			end
