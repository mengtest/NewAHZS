...
BT1044 = Mogo.AI.BehaviorTreeRoot:new()

function BT1044:new()
		 
			local tmp = {}
			setmetatable(tmp, {__index = BT1044})
			tmp.__index = tmp
				...
				do
					...
					do
						...
						do
							...
							do
								...
								do
									...
									node14:AddChild(Mogo.AI.CmpRate:new(Mogo.AI.CmpType.lt,15));
						...
						do
							...
							do
								...
								do
									...
									node25:AddChild(Mogo.AI.CmpRate:new(Mogo.AI.CmpType.lt,30));
						...
						do
							...
							node33:AddChild(Mogo.AI.EnterRest:new(0));
						end
					end
				end
			end
